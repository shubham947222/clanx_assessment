...
function App() {
  ...
  const getUVIdata = (lat, lon) => {
    ...
    axios
      .get("https://api.openweathermap.org/data/2.5/uvi", { params })
      .then((res) => {
        // setWeatherData(res?.data?.current)
  ...
  return (
    <div className="w-screen h-screen   bg-[#D6D7DA]">
      <div class="flex flex-col lg:flex-row ">
        ...
        <div class="lg:w-3/5 bg-[#F6F6F8]">
          <Main
            weatherData={weatherData}
            weekData={weatherForecastData?.list}
            hourlyData={weatherForecastData?.list}
